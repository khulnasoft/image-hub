...
export default {
    ...
    data: () => ({
        ...
        images: [
            "khulnasoft / meshery",
            "khulnasoft / meshery-nsm",
            "khulnasoft / meshery-consul",
            "khulnasoft / meshery-octarine",
            "khulnasoft / meshery-istio",
            "khulnasoft / meshery-linkerd",
            "khulnasoft / meshery-cloud",
            "khulnasoft / meshery-cpx",
            "khulnasoft / meshery-maesh",
            "khulnasoft / meshery-kuma",
            "khulnasoft / meshery-app-mesh",
            "khulnasoft / meshery-nsx-sm",
            ],
        dialog: false,
        dialogTitle: "",
        dialogBody: "",
