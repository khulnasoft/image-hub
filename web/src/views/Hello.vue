<template>
      ...
      <v-list-item-content class="ma-6">
        ...
        <v-list-item-title class="headline mb-1">KhulnaSoft</v-list-item-title>
...
export default {
    ...
    data: () => ({
        ...
        images: [
            "khulnasoft / meshplay",
            "khulnasoft / meshplay-nsm",
            "khulnasoft / meshplay-consul",
            "khulnasoft / meshplay-octarine",
            "khulnasoft / meshplay-istio",
            "khulnasoft / meshplay-linkerd",
            "khulnasoft / meshplay-cloud",
            "khulnasoft / meshplay-cpx",
            "khulnasoft / meshplay-maesh",
            "khulnasoft / meshplay-kuma",
            "khulnasoft / meshplay-app-mesh",
            "khulnasoft / meshplay-nsx-sm",
            ],
        dialog: false,
        dialogTitle: "",
        dialogBody: "",
